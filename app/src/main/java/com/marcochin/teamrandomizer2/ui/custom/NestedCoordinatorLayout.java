package com.marcochin.teamrandomizer2.ui.custom;
...
/**
 * We use this class because we want to put the snackbar in a different position when the keyboard
 * is open. The reason is because the keyboard covers the snackbar when the keyboard is shown. To
 * work-around this we have to have another coordinator layout in which we can reference and pass
 * to the snackbar. However, we can't have nested coordinator layouts so we have to create a custom
 * class.
 * https://stackoverflow.com/a/52287572/5673746
 */
